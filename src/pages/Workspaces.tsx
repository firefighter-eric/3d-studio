  ...
  return <>
    ...
    <section className="workspace-layout model-workspace">
      ...
      <aside className="workspace-sidebar">
        ...
        </> : apple ? <AppleDetails id={apple.id} /> : nvidia ? <NvidiaDetails id={nvidia.id} /> : <dl className="model-details"><div><dt>创作方式</dt><dd>{car ? '程序化建模 · GLB' : '原创设计'}</dd></div><div><dt>使用方式</dt><dd>查看 · 场景组合{id === 'rocket' || id === 'basalt' || car ? ' · 游戏' : ''}</dd></div></dl>}
